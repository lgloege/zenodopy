...
def test_get_depositions():
    zeno = zen.Client()
    if zeno._get_depositions() is None:
        pass
    if zeno._get_depositions_by_id(dep_id='123') is None:
        pass
    if zeno._get_depositions_files() is None:
        pass


def test_get_bucket():
    zeno = zen.Client()
    if zeno._get_bucket_by_id(dep_id='123') is None:
        pass
